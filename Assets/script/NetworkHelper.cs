...
public class NetworkHelper : MonoBehaviour
{
    ...
    private static void RunningControls()
    {
        ...
        UnityTransport transport = netMgr.GetComponent<UnityTransport>(); // Specify the type argument
        string serverPort = "?";
        if (transport != null)
        {
    ...
    {
        ulong ownerId = what.GetComponent<NetworkObject>().OwnerClientId; // Specify the type argument
